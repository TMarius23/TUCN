...
class CalcView extends JFrame {
    ...
    CalcView(CalcModel model) {
        ...
        JPanel content_middle = new JPanel();
        content.setLayout(new FlowLayout());
        content.add(new JLabel("Input"));
        content.add(m_userInputTf);
        content_middle.setLayout(new GridLayout(2, 1));
        content_middle.add(m_multiplyBtn);
        content_middle.add(m_addBtn);
        content.add(content_middle);
